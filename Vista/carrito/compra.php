...
<body>
    <header>
    <div class="BackGroundxd" style="background-image: url('Vista/img/BackGround.jpg');"></div>
        <div class="container">
            <div class="row justify-content-between mb-5">
                <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
                    <a class="navbar-brand" href="../../Vista/carrito/index.html">PSCINP</a>
                    ...
                    <form id="procesar-pago" action="#" method="post">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-md-4 mb-2">
                                <a href="../../Vista/carrito/index.php" class="btn btn-info btn-block">Seguir comprando</a>
                            </div>
    ...
    <script src="../../Vista/carrito/js/compra.js"></script>
